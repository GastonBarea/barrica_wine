...
<head>
   ...
   <meta name="author" content="Anibal Giboudot, Sebastián Martín Perez, Gaston Alan Barea">
    ...
    <header>  
        ...
        <nav class="navbar navbar-expand-lg fixed-top">
         ...
         <div class="container-fluid barranprincipal">
          ...
          <a href="index.html"><img src="img/bwmin.png" alt="logo" width="59" height="50"></a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <li><a class="dropdown-item" href="productos.php">Linea Tintos</a></li>
                                    <li><a class="dropdown-item" href="productos.php">Linea Blancos</a></li>
                                    <li><a class="dropdown-item" href="productos.php">Linea Rosados</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
