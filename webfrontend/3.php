  ...
  <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4">
                            <article class="">
                                <div class="card">
                                    <img src="<?php echo $productos[3]['imagenLG'];?>" alt="...">
                                    <div class="card-body">
                                        <p><?php echo $productos[3]['nombre'];?></p>
                                        <p><?php echo $productos[3]['marca'];?></p>
                            ...
                            <article class="">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h4><?php echo $productos[3]['marca'];?></h4>
                                        <p class="card-text"><?php echo "$ ".$productos[3]['precio'];?></p>
                                        <p class="card-text"><?php echo $productos[3]['contenido'];?></p>
                            ...
                            <article class="">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><?php echo $productos[3]['precio'];?></p>
                                        <p class="card-text"><?php echo $productos[3]['contenido'];?></p>
                                        <p class="card-text"><?php echo $productos[3]['cosecha'];?></p>
                                        <p class="card-text"><?php echo $productos[3]['categotiaTipo'];?></p>
                                        <p class="card-text"><?php echo $productos[3]['descripcion'];?></p>
