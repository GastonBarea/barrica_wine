  ...
  <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4">
                            <article class="">
                                <div class="card">
                                    <img src="<?php echo $productos[2]['imagenLG'];?>" alt="...">
                                    <div class="card-body">
                                        <p><?php echo $productos[2]['nombre'];?></p>
                                        <p><?php echo $productos[2]['marca'];?></p>
                            ...
                            <article class="">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h4><?php echo $productos[2]['marca'];?></h4>
                                        <p class="card-text"><?php echo "$ ".$productos[2]['precio'];?></p>
                                        <p class="card-text"><?php echo $productos[2]['contenido'];?></p>
                            ...
                            <article class="">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><?php echo $productos[2]['precio'];?></p>
                                        <p class="card-text"><?php echo $productos[2]['contenido'];?></p>
                                        <p class="card-text"><?php echo $productos[2]['cosecha'];?></p>
                                        <p class="card-text"><?php echo $productos[2]['categotiaTipo'];?></p>
                                        <p class="card-text"><?php echo $productos[2]['descripcion'];?></p>
